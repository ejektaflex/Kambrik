...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            // NOTE neoforge was not included at the bottom of this file
            val Platform = object {
                val MC = "1.21"
            ...
            library("fabric-api", "net.fabricmc.fabric-api:fabric-api:${Platform.FabricApi}")
