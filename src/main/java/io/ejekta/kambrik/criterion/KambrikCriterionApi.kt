...
class KambrikCriterionApi internal constructor() {
    ...
    private val predicateDeserializer = AdvancementEntityPredicateDeserializer(
        KambrikMod.idOf("advancement_entity_predicate_deserializer"), null
    )
    ...
    internal fun <T : AbstractCriterionConditions> handleGameTrigger(player: ServerPlayerEntity, criterion: AbstractCriterion<AbstractCriterionConditions>, predicate: Predicate<AbstractCriterionConditions>) {
