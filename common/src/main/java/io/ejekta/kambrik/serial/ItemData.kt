...
//
//    abstract val type: DataComponentType<T>
//
...
//        }
//
//        val comp = stack.components.get(type)
//
...
//            Kambrik.Logger.error("Failed to decode leaf '$type' in stack $stack (type: ${stack.item::class.simpleName})")
